...
export default function HomeView({ setActiveTab, openQuoteForPlan }: HomeViewProps) {
  return (
    <div className="bg-slate-50 min-h-screen font-sans" id="home-view-root">
      ...
      <section className="bg-slate-50 pt-16 pb-8 px-4 sm:px-8 lg:px-16 border-t border-slate-100" id="plan-secure-future">
      ...
      <section className="bg-[#005AAA] py-6 px-4 sm:px-8 lg:px-16 text-white relative">
        <div className="max-w-none mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 items-center relative z-10">
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2">
              {[
                ...
                <div key={idx} className="flex items-center space-x-2 bg-blue-600/30 border border-blue-400/30 px-2.5 py-1.5 rounded shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-3">
              <button 
                ...
                className="bg-[#E25224] hover:bg-orange-600 text-white font-bold px-6 py-2.5 rounded shadow-sm hover:shadow-md transition-all cursor-pointer"
              >
                Apply Now
              </button>
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-transparent hover:bg-blue-800 text-white font-bold px-5 py-2.5 rounded border-2 border-white shadow-sm hover:shadow-md transition-all flex items-center space-x-2 cursor-pointer"
              >
          ...
          <div className="lg:col-span-6 relative">
            <div className="bg-white p-2 rounded-2xl shadow-2xl transform md:rotate-2 hover:rotate-0 transition-transform duration-500 max-w-xl ml-auto w-full">
              <img 
